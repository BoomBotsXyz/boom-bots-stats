...
function getNetworkSettings(chainID) {
  //const KNOWN_CHAINS = [1, 5, 11155111, 137, 80001, 1313161554, 1313161555];
  const KNOWN_CHAINS = [168587773];//[8453, 84531, 80001];
  ...
  // testnets
  const TESTNETS = [5, 11155111, 80001, 1313161555, 84531, 168587773];
